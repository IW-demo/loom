...
The a large project session loaded 25+ rules but only 8-10 were in the agent's active context at any time — the rest loaded on demand when relevant files were touched.
