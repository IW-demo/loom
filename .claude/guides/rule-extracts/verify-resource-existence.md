...
2026-05-03 ci-queue-monitor session — 6 consecutive PRs (#766, #769, #770, #771, #772, #773) + 2 user PAT-creation cycles spent debugging access to a 16-core GitHub-hosted runner that did not exist in the `terrene-foundation` org.

The single command `gh api orgs/terrene-foundation/actions/hosted-runners` at the first 403 (PR #765 verification) would have shown a one-runner list with no 16-core entry and shifted the disposition immediately to "delete the dead step."
