...
$ /onboard
Output:
  Welcome to multi-operator COC. Identity: maintainer (unrostered).
...
$ /whoami --register
Output:
  Drafted register proposal at .claude/.proposals/register-maintainer.yaml
...
Walk: $ /whoami
Output: "person:maintainer verified:gh-maintainer disp:maintainer role:owner posture:L5"
