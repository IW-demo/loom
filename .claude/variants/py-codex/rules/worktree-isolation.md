...
ls "$worktree/src/feature.py"  # parent checks; raises if missing → retry
...
Delegate to a worker subagent (isolation=worktree).
Operating spec: "$(cat .codex/prompts/specialist-ml.md)"
Task: Edit packages/kailash-ml/src/kailash_ml/trainable.py at line 370...
...
Delegate to a worker subagent (isolation=worktree).
Operating spec: "$(cat .codex/prompts/specialist-ml.md)"
Task: Edit $worktree/packages/kailash-ml/src/kailash_ml/trainable.py at line 370...

# DO NOT — absolute paths pointing to the PARENT checkout
Delegate to a worker subagent (isolation=worktree).
Operating spec: "$(cat .codex/prompts/specialist-ml.md)"
Task: Edit /Users/<user>/repos/myproject/packages/kailash-ml/src/kailash_ml/trainable.py at line 370...
