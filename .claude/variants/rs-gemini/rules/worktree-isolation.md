...
let worktree = "/Users/<user>/repos/myproject/.gemini/worktrees/agent-feature-abc123";
...
@ml-specialist
isolation: worktree
prompt: "Write {worktree}/src/feature.rs..."
// (parent then checks: std::path::Path::new(&format!("{worktree}/src/feature.rs")).exists())
...
@ml-specialist
isolation: worktree
prompt: "Edit packages/kailash-ml/src/trainable.rs at line 370..."
...
@ml-specialist
isolation: worktree
prompt: "Edit {worktree}/packages/kailash-ml/src/trainable.rs at line 370..."

// DO NOT — absolute paths pointing to the PARENT checkout
@ml-specialist
isolation: worktree
prompt: "Edit /Users/<user>/repos/myproject/packages/kailash-ml/src/trainable.rs at line 370..."
