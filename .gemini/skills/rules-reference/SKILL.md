...
| Cross-Repo Target Resolution | `.claude/**`, `sync-manifest.yaml`, `**/*.mjs`, `**/*.js` | `.claude/rules/cross-repo.md` |
...
| loom ↔ csq Boundary Rule | `**/.claude/test-harness/**`, `**/.claude/rules/loom-csq-boundary.md`, `**/test-harness/fixtures/**` | `.claude/rules/loom-csq-boundary.md` |
